...
![1](https://the0n3.top/medias/hackbar/1.png)

![2](https://the0n3.top/medias/hackbar/2.png)

## 测试与分析

在网页中打开hackbar，会弹出需要输入证书，不管这个license证书，直接测试它的按钮功能

![3](https://the0n3.top/medias/hackbar/3.png)

又找到一个好玩的，chrome自带对插件的开发者功能，右键检查，可以看到对插件的调试

点击加载url按钮，控制台报错

![4](https://the0n3.top/medias/hackbar/4.png)
...
![5](https://the0n3.top/medias/hackbar/5.png)
...
![7](https://the0n3.top/medias/hackbar/7.png)

![6](https://the0n3.top/medias/hackbar/6.png)

可以看到可以加载当前url了

修改搜索内容，点击执行按钮，现在也可以使用了

![8](https://the0n3.top/medias/hackbar/8.png)

再深入挖掘，点击load,split,exec等按钮时，实际是触发了页面的点击事件，右键检查其中的一个按钮

在exec按钮对应的click事件中，有一处是与hackbar相关的

![9](https://the0n3.top/medias/hackbar/9.png)

跟进后，还可以看到其他两个按钮点击事件的触发函数，在函数内部都调用了`check_license`函数

![10](https://the0n3.top/medias/hackbar/10.png)
...
![11](https://the0n3.top/medias/hackbar/11.png)
...
![12](https://the0n3.top/medias/hackbar/12.png)

![13](https://the0n3.top/medias/hackbar/13.png)
...
![14](https://the0n3.top/medias/hackbar/14.png)
...
![15](https://the0n3.top/medias/hackbar/15.png)
...
![18](https://the0n3.top/medias/hackbar/18.png)

记录chrome商店中安装的hackbar插件的id

![19](https://the0n3.top/medias/hackbar/19.png)

在chrome安装目录下，找到对应id的文件夹

![20](https://the0n3.top/medias/hackbar/20.png)
...
![21](https://the0n3.top/medias/hackbar/21.png)

在页面再次打开破解的hackbar，已经没有警告框了，功能正常使用

![22](https://the0n3.top/medias/hackbar/22.png)
