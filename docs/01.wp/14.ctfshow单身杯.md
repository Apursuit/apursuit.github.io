...
![4](https://the0n3.top/medias/show-DSB/4.png)
...
![9](https://the0n3.top/medias/show-DSB/9.png)
...
![11](https://teh0n3.top/medias/show-DSB/11.png)

这里预期希望达到一个像sql盲注的效果，通过提示判断flag每一位的值

![12](https://teh0n3.top/medias/show-DSB/12.png)
...
![13](https://teh0n3.top/medias/show-DSB/13.png)

很棒的一道题！

关于`迷雾重重`,`文件上传`这两天接着复现